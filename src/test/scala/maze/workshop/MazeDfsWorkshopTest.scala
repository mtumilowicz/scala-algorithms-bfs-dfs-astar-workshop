...
import algorithms.workshop.DfsWorkshop
import maze.{Cell, Location, Maze}
import org.scalatest.GivenWhenThen
import org.scalatest.featurespec.AnyFeatureSpec
import org.scalatest.matchers.should.Matchers.convertToAnyShouldWrapper

class MazeDfsWorkshopTest extends AnyFeatureSpec with GivenWhenThen {
  ...
  Feature("solve the maze") {
    Scenario("unsolvable maze") {
      ...
      When("solve")
      val solution = DfsWorkshop.run(maze.start, maze.checkIfGoalAchieved, maze.successors)
